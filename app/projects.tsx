...
export default function Projects() {
  return (
    <div className="w-full  flex items-center flex-col p-4 md:p-20">
      ...
      <div className="flex flex-wrap justify-center items-center">
        {projects.map(project => (
          ...
          key={project.title} className='w-72 md:w-[30rem] h-auto m-4 p-4 md:m-20 md:p-10 bg-blue-900 flex flex-col items-center rounded-xl'>
